package com.buyi.util.lang;

import java.net.InetAddress;
import java.net.UnknownHostException;

/**
 * 生成分布式ID，基于twitter snowflake算法 <br>
...
public class GenerateIdUtil {
	...
	private static final GenerateIdUtil snowflake = new GenerateIdUtil();
	 ...
	 *            数据中心ID (0~31)
	 */
	public GenerateIdUtil() {
		this.workerId = getIPAddr();
	...
	private long getIPAddr() {
		...
		ipAddr = (long) (((ipAddressByteArray[ipAddressByteArray.length - 2] & 0B11) << Byte.SIZE)
