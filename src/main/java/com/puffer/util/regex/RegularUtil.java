...
public class RegularUtil {
	...
	public static boolean isEmail(String email) {
		return match(email, RegularExpression.EMAIL_REGEX);
	}
	...
	public static boolean isChinessName(String name) {
		return match(name, RegularExpression.CH_NAME_REGEX);
	}

	public static boolean isDateTime(String dateTime) {
		return match(dateTime, RegularExpression.DATE_FORMAT_DATETIME);
	}
